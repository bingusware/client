...
public abstract class Minecraft implements Runnable, IPlayerUsage
{
    ...
    public void runTick()
    {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    /**
                     * @edited 7/19/21
                     * @purpose Notify the Client when a key is pressed
                     */
                    Client.callEvent(Client.EventType.KEYPRESS, Keyboard.getEventKey() == 0 ? Keyboard.getEventCharacter() + 256 : Keyboard.getEventKey());
                }
            }
        ...
        /**
         * @edited 7/19/21
         * @purpose Notify the Client each tick
         */
        Client.callEvent(Client.EventType.TICK);
    }
    ...
    public CrashReport addGraphicsAndWorldToCrashReport(CrashReport par1CrashReport)
    {
        ...
        par1CrashReport.func_85056_g().addCrashSectionCallable("EventType", new CallableType2(this));
