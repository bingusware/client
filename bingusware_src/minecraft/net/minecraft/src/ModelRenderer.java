...
public class ModelRenderer
{
    ...
    public ModelRenderer(ModelBase par1ModelBase, String par2Str)
    {
        ...
        /**
         * @edited 7/2/22
         * @purpose somehow setting the default height at 64f fixes the bug where the texture maps incorrectly!? what
         */
            ...
            if (this.showModel)
            {
                ...
                if (this.rotateAngleX == 0.0F && this.rotateAngleY == 0.0F && this.rotateAngleZ == 0.0F)
                {
                    if (this.rotationPointX == 0.0F && this.rotationPointY == 0.0F && this.rotationPointZ == 0.0F)
                    {
                        ...
                        if (this.childModels != null)
                        {
                            for (k = 0; k < this.childModels.size(); ++k)
                            {
                                ((ModelRenderer)this.childModels.get(k)).render(par1);
                            }
                        }
                    }
                    else
