...
public class GuiMainMenu extends GuiScreen
{
    ...
    public GuiMainMenu()
    {
        ...
        var3 = System.getProperty("java_version");
		 ...
		 /**
         * @edited 7/20/21
         * @purpose remove update notice
         */
        if ("ppc".equalsIgnoreCase(var14))
        {
            this.field_92025_p = "" + EnumChatFormatting.BOLD + "Notice!" + EnumChatFormatting.RESET + " Please stop using PowerPC";
            this.field_104024_v = "http://tinyurl.com/javappc";
        }
        else if (var3 != null && var3.startsWith("1.5"))
        {
            this.field_92025_p = "" + EnumChatFormatting.BOLD + "Notice!" + EnumChatFormatting.RESET + " Please update to Java 1.6 or later";
            this.field_104024_v = "http://tinyurl.com/javappc";
        }
    }
